          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex flex-column align-items-center text-center">
                {/* this is a prop children  that its included between open and closed tags of the component */}
                {props.children}
...
Profile.defaultProps = {
    email: "leithgharbi@yahoo.fr",
    phone: 97913883,
    Adress: "Ariana ",
    website: "N/A",
    github: "https://github.com/Leith-Gharbi",
    twitter:"N/A",
    instagram:"leith gharbi",
    facebook:"leith gharbi",
   };
